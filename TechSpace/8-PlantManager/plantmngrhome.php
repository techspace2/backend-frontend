...
<head>
    ...
    <link rel="stylesheet" href="plantmngrhome.css">
...
<body>
    ...
    <div class="flex-details">
        ...
        <img src="pm 1.png" alt="">


        <div class="chairman-details">

            <h1>Welcome, Plant Manager !</h1>

            <p>We are delighted to welcome you to our platform! As a valued Plant Manager, 
                you now have access to a comprehensive suite of tools for plant and operations management. 
                These resources are designed to help you optimize operational strategies, collaborate with your team, 
                and track key performance metrics to drive efficiency, profitability, and sustainable growth.
            </p>
    ...
    <div class="roles-response-slideshow">
        ...
        <div class="left-side">
            ...
            <ul class="roles-list">
                ...
                <li>Designing and executing strategies to improve plant efficiency and contribute to business growth.</li>
                <li>Leading decision-making and discussions in plant management meetings.</li>
                <li>Ensuring cost control, equipment performance, and effective risk management.</li>
                <li>Aligning plant objectives with overall company goals to optimize results.</li>
                <li>Cultivating strong partnerships with suppliers, contractors, and industry stakeholders to enhance operations.</li>
                <li>Providing mentorship and guidance to plant teams to foster leadership development.</li>
    ...
    <div class="tools">
        ...
        <div class="image-container">
            ...
            <div class="text-overlay">Meetings</div>
            <p class="p-overlay"> The process of planning, organizing, and setting up appointments or discussions between individuals or groups. </p>
            <a class="btn-overlay" href="../plant functions/Staff Meeting/staffmeeting.php">Schedule Meetings</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="dept-text-overlay">Machinery & Equipment</div>
            <p class="p-overlay"> Refers to the physical assets used in production.</p>
            <a class="btn-overlay-add" style="top: 70%;" href="../plant functions/Machinery  Equipment/machinery.php">Manage <br> Machinery &  Equipment</a>
        </div>

        
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="task-overlay" style="left: 38%;">Product</div>
            <p class="p-overlay">Refers to any item or service that is created or manufactured.</p>
            <a class="btn-overlay-addprod" style="top: 70%;" href="../shopping cart/admin.php">Manage Products</a>
        </div>
        ...
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay-product">Product Shipping Details</div>
            <p class="p-overlay">The specific information regarding the delivery of a product from the seller to the buyer.</p>
            <a class="btn-overlay" href="../plant functions/Product Shipping Details/shippingdetails.php">Add Product Shipping <br>Details</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="feedback-overlay">Product Manufacturing <br> Process</div>
            <p class="p-overlay">Series of steps and operations involved in turning raw materials or components.</p>
            <a class="btn-overlay-plans1" style="top: 70%;" href="../plant functions/Product Manfacturing/productmanfac.php">Manage Manufacturing Process</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="company-overlay">Inventory of Finished Good</div>
            <p class="p-overlay-opr">Refers to the stock of completed products that are ready for sale or distribution.</p>
            <a class="btn-overlay-client" style="top: 70%;" href="../plant functions/Inventory/inventory.php">Add Inventory</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="task-overlay" style="left: 26%;">Delivery Schedule</div>
            <p class="p-overlay">The planned timeline for delivering products or services to customers or other stakeholders.</p>
            <a class="btn-overlay-addsch" style="top: 70%;" href="../plant functions/Delivery Schedule/del schedule.php">Add Delivery Schedule</a>
