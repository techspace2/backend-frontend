...
<body>
    ...
    <div class="flex-details">
        ...
        <div class="chairman-details">
            ...
            <h1>Welcome, General Manager !</h1>

            <p>We’re excited to welcome you to our platform. As a respected general manager you now have access to a full range of management tools and resources that will assist you in efficiently managing the organization’s operations, working with your team, and tracking key performance indicators to foster ongoing growth and success.    </p>
    ...
    <div class="roles-response-slideshow">
        ...
        <div class="left-side">
            ...
            <ul class="roles-list">
                ...
                <li>Providing strategic oversight of the organization’s operational plans and ensuring the  implementation of long-term growth initiatives.</li>
                <li>Leading key meetings and aiding in high-level decision-making processes.</li>
                <li>Managing financial stability, ensuring regulatory compliance, and addressing risk management.</li>
                <li>Working closely with senior leadership to define goals and drive the company’s priorities.</li>
                <li>Acting as the organization’s representative in external partnerships and industry events</li>
                <li>Providing leadership and mentorship to executive teams to enhance their management skills.</li>
    ...
    <div class="tools">
        ...
        <div class="image-container">
            ...
            <div class="text-overlay">Daily Schedule</div>
            <p class="p-overlay">Ensures smooth workflow, efficiency, and productivity. It typically includes structured time slots for different activities.</p>
            <a class="btn-overlay" href="../General Manager Functions/Daily Schedule/Dailyschedule.php">Manage Daily Schedules</a>
        </div>

        <div class="image-container-opr">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay-opr">Factory Operation</div>
            <p class="p-overlay" style="top: 35%;">The processes and activities involved in manufacturing goods within a factory setting.</p>
            <a class="btn-overlay-set" style="width: 255px; left: 18%; top: 70%; " href="../General Manager Functions/Factory Operation/factoperation.php">Manage Factory Operations</a>
        </div>

        
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="task-overlay">Productivity Level</div>
            <p class="p-overlay">Measures the efficiency of workers in converting labor hours into finished products.</p>
            <a class="btn-overlay" href="../General Manager Functions/Productivity Level/Prodlevel.php">View Productivity Level</a>
        </div>
        ...
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay">Leave Requests</div>
            <p class="p-overlay">A formal request made by an employee to take time off from work.</p>
            <a class="btn-overlay" href="../General Manager Functions/Leave Request/Leavereq.php">Approve Leave Requests</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="feedback-overlay">Purchase Report</div>
            <p class="p-overlay">A Purchase Report is a document that provides details about an organization's purchases over a specific period.</p>
            <a class="btn-overlay-client" href="../Reports/purchase reports/pdf.php" target="_blank">Create Purchase Reports</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="feedback-overlay-purch" style="left: 28%;">Purchase Order</div>
            <p class="p-overlay">A factory setting refer to the process of acquiring raw materials, equipment, and other essential supplies required for production.</p>
            <a class="btn-overlay-client" href="../General Manager Functions/Approve Purch/approvepurch.php">Approve Purchases</a>
        </div>
