...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save'])) {
    ...
    if (mysqli_num_rows($result) == 0) {
        ...
        $query = "INSERT INTO SpecialBenefit (WorkerId, SBenefitDesc, SBenefitAmount, PayrollId) 
          VALUES ('$worker_id', '$desc', '$amount', '$id')";


        if (mysqli_query($conn, $query)) {
            $_SESSION['success'] = "Special Benefit Added Successfully";
...
<body>
    ...
    <div class="container">
        ...
        <div class="body-container">
            ...
            <div class="back1">
                ...
                <div class="info">
                    <label for="">BENEFIT AT TECHSPACE</label>
                    <h1>SPECIAL BENEFIT</h1>
                    <p>"Techspace offers cutting-edge apparel that blends innovation with style. Our special benefit lies in integrating advanced fabric technology, ensuring superior comfort, durability, and performance. Whether it's moisture-wicking, temperature control, or eco-friendly materials, we prioritize quality and sustainability."</p>
                </div>
    ...
    <div class="main-flex" style="display: flex; flex-direction: column;justify-content: center; gap: 35px; align-items: center; flex-wrap: wrap; background-color: rgba(217, 217, 217, 0.32);
        ...
        <div class="left1" style="display: flex; align-items: center; gap: 199px;">
        ...
        <div class="left1" style="display: flex; align-items: center; gap: 100px;">
            <label style="font-size: 24px; color: rgb(66, 66, 66);">Benefit Description</label>
            <textarea name="txtdesc" id="" style="width: 390px; height: 135px; border-radius: 12px; font-size: 20px; padding-left: 10px; padding-top: 10px; border: none; background-color: rgb(226, 223, 223); outline: none;"></textarea>
        </div>

        <div class="left1" style="display: flex; align-items: center; gap: 140px;">
            <label style="font-size: 24px; color: rgb(66, 66, 66);">Benefit Amount</label>
