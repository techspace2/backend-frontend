...
<head>
    ...
    <link rel="stylesheet" href="financialofficer.css">
...
<body>
    ...
    <div class="flex-details">
        ...
        <img src="financialofficer.png" alt="">


        <div class="chairman-details">

            <h1>Welcome, Financial Officer !</h1>

            <p>We are thrilled to welcome you to our platform! As a valued Financial Officer, 
                you now have access to a comprehensive suite of financial management tools and resources. 
                These are designed to help you oversee the organization's financial strategy, collaborate with your team, 
                and monitor key financial metrics to drive sustainable growth and success.
            </p>
    ...
    <div class="roles-response-slideshow">
        ...
        <div class="left-side">
            ...
            <ul class="roles-list">
                ...
                <li>Overseeing financial strategy and long-term growth initiatives.</li>
                <li>Leading financial meetings and decision-making processes.</li>
                <li>Ensuring financial stability, regulatory compliance, and effective risk management</li>
                <li>Aligning financial objectives with company priorities.</li> 
                <li>Managing investor relations, financial partnerships, and industry engagements to drive growth.</li>
                <li>Providing financial guidance and mentorship to executive teams to enhance fiscal leadership capabilities.</li>
                <li>Providing financial guidance to executive teams.</li>
        ...
        <div class="slideshow-container">
            ...
            <div class="slideshow">
                ...
                <img src="../1-Chairman/07.png" class="slide">
    ...
    <div class="tools">
        ...
        <div class="image-container">
            ...
            <div class="text-overlay">Financial Plan</div>
            <p class="p-overlay">Outlines an organization's financial goals, strategies, and projections to ensure stability, growth, and long-term success.</p>
            <a class="btn-overlay" href="../Financial Officer Functions/Financial Plan/financialplan.php">Set Financial Plans</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay-budget">Financial Budget</div>
            <p class="p-overlay"> A detailed plan outlining an organization’s projected income, expenses .</p>
            <a class="btn-overlay-setbud" style="top: 70%;" href="../Financial Officer Functions/Budget/budget.php">Manage Financial Budget</a>
        </div>

        
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="task-overlay">Expense & Revenue</div>
            <p class="p-overlay">The  fundamental components of a company’s financial performance. </p>
            <a class="btn-overlay-rev" href="../Financial Officer Functions/Revenue/revenue.php">Track Revenue</a>
            <a class="btn-overlay-ex" href="../Financial Officer Functions/Expenses/expenses.php">Track Expenses</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay-profit">Profit & Loss Statement</div>
            <p class="p-overlay"> A financial document that summarizes a company’s revenues, expenses, and profits or losses over a specific period.</p>
            <a class="btn-overlay" href="../Reports/P & L/pdf.php" target="_blank">Review Profit & Loss <br> Statements</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="feedback-overlay">Accounts</div>
            <p class="p-overlay">A financial context refer to systematic records used by a business or organization to track and report financial transactions</p>
            <a class="btn-overlay-client" href="../Financial Officer Functions/Accounts/accounts.php">Handle Accounts</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="feedback-overlay-report">Financial Report</div>
            <p class="p-overlay"> A structured document that provides a overview of an organization’s financial status.</p>
            <a class="btn-overlay-uprep" style="top: 70%;" href="../Reports/Financial reports/pdf.php" target="_blank">Create Financial Report</a>
        </div>

        
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="trans-overlay">Financial Transaction</div>
            <p class="p-overlay">These transactions involve the exchange of money or a monetary equivalent and are recorded in the company's accounting system.</p>
            <a class="btn-overlay-client" href="../Financial Officer Functions/Transaction Details/transaction.php">Process Financial <br> Transaction</a>
        </div>
    ...
    <form method="post" class="feedback-form"><style>
        .flex-details1{
            font-family: "inter", serif;
        }
    </style>
