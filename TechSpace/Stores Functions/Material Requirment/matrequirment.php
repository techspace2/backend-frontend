...
if (isset($_POST['update_task'])) {
    ...
    mysqli_query($conn, "UPDATE MaterialRequirement SET MReqStatus='$status' WHERE MReqID='$taskID'");
...
<body>
    ...
    <h1 style="font-size: 45px; margin-top: 70px; margin-left: 100px;"> <span style="color: rgb(235, 47, 47);">Supplier</span> Details</h1>
    <table class="content-table" style="border-collapse: collapse; margin-top: 70px; margin-left: 170px;">
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result2) > 0) {
                ...
                echo "<tr style='background-color:rgba(255, 255, 255, 0.164);font-size: 25px;border-bottom:none;'>
                            ...
                            <td style='width: 300px;  padding:20px; text-align: center; display: flex; align-items: center; justify-content: center; gap:70px; font-size: 21px;' >
...
<h2 style="font-size: 45px; margin-left: 100px; margin-top:90px;"><?php echo isset($edit_task) ? "Edit Task" : "Finalize <span style='color: rgb(235, 47, 47);'>Material</span> Requirement"; ?></h2>
    ...
    <div class="main-flex" style="display: flex; flex-direction: column;justify-content: center; gap: 35px; align-items: center; flex-wrap: wrap; background-color: rgba(217, 217, 217, 0.32);
        width: 40%; padding: 65px; border-radius: 40px; margin-left: 490px; margin-top: 100px;  box-shadow: 4px 4px 10px rgba(0, 0, 0, 0.2);">
            ...
            <div class="left" style="display: flex; align-items: center; gap: 148px;" >
                ...
                <input type="text" readonly style="z-index: 1;width: 390px; height: 55px; border-radius: 12px; font-size: 20px; padding-left: 10px; border: none; background-color: rgb(226, 223, 223); outline: none;" name="txtsid" value="<?php echo isset($edit_task) ? $edit_task['SupplierId'] : ''; ?>" required>
            </div> 
            
            <div class="left" style="display: flex; align-items: center; gap: 148px;" >
                <label style="font-size: 24px; color: rgb(66, 66, 66);">Material Inventory ID</label>
                <input type="text" readonly style="z-index: 1;width: 390px; height: 55px; border-radius: 12px; font-size: 20px; padding-left: 10px; border: none; background-color: rgb(226, 223, 223); outline: none;" name="txtmid" value="<?php echo isset($edit_task) ? $edit_task['MaterialInvenID'] : ''; ?>" required>
            </div>     
            ...
            <div class="left" style="display: flex; align-items: center; gap: 110px;" >
                ...
                <input type="text" readonly style="z-index: 1;width: 390px; height: 55px; border-radius: 12px; font-size: 20px; padding-left: 10px; border: none; background-color: rgb(226, 223, 223); outline: none;" style="width: 390px; height: 55px; border-radius: 12px; font-size: 20px; padding-left: 10px; border: none; background-color: rgb(226, 223, 223); outline: none;"name="txtname" value="<?php echo isset($edit_task) ? $edit_task['MReqName'] : ''; ?>" required>
            </div>
            ...
            <div class="left" style="display: flex; align-items: center; gap: 170px;" >
                ...
                <input type="text" readonly style="z-index: 1;width: 390px; height: 55px; border-radius: 12px; font-size: 20px; padding-left: 10px; border: none; background-color: rgb(226, 223, 223); outline: none;" style="width: 390px; height: 55px; border-radius: 12px; font-size: 20px; padding-left: 10px; border: none; background-color: rgb(226, 223, 223); outline: none;"name="txtquantity" value="<?php echo isset($edit_task) ? $edit_task['MReqQuantity'] : ''; ?>" required>
            </div>    
            ...
            <div class="left" style="display: flex; align-items: center; gap: 50px;">
                ...
                <select name="txtstatus"  style="z-index: 1;width: 400px; height: 55px; border-radius: 12px; font-size: 20px; padding-left: 10px; border: none; background-color: rgb(226, 223, 223); outline: none;" required>
