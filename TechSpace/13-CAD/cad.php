...
<body>
    ...
    <div class="flex-details">
        ...
        <img src="cad 1.png" alt="">


        <div class="chairman-details">

            <h1>Welcome, CAD Engineer !</h1>

            <p>We are excited to welcome you to our platform! As a valued CAD Engineer, you now have access to a complete set of tools and resources to 
                help you optimize design processes, collaborate with your team, and track key performance metrics to enhance technical efficiency and project success.</p>
    ...
    <div class="roles-response-slideshow">
        ...
        <div class="left-side">
            ...
            <ul class="roles-list">
                ...
                <li>Strategically managing design and drafting processes, ensuring the successful implementation of long-term technical and project development plans.</li>
                <li>Leading crucial CAD design meetings and supporting high-level decision-making for design-related projects.</li>
                <li>Overseeing design tasks, ensuring compliance with industry standards, and addressing risks associated with technical specifications and project needs.</li>
                <li>Working closely with senior leadership to establish design goals and align them with the company’s broader objectives.</li>
                <li>Representing the company in external technical collaborations, industry events, and initiatives focused on design innovation.</li>
    ...
    <div class="tools">
        ...
        <div class="image-container">
            ...
            <div class="text-overlay-supplier">Product Design</div>
            <p class="p-overlay">the process of creating and developing new products.</p>
            <a class="btn-overlay-add" style="top: 70%;" href="../CAD functions/Product Design/productdesign.php">Manage Product Design</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="feedback-overlay">Custom Design</div>
            <p class="p-overlay">The process of creating unique, tailored products or solutions.</p>
            <a class="btn-overlay-client" style="top: 70%;" href="../CAD functions/Custom Design/cusdesign.php">Manage Custom Design</a>
        </div>
