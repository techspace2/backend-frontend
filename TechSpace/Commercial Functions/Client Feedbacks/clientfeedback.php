...
<head>
    ...
    <link rel="stylesheet" href="clientfeedback.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="body-container">
            ...
            <div class="back1">
                ...
                <div class="info">
                    <label for="">CLIENT FEEDBACK AT TECHSPACE</label>
                    <h1>Client Feedback</h1>
                    <p>"We at Techspace truly appreciate our clients' valuable feedback! Your insights help us continuously improve our apparel, ensuring top-notch quality, comfort, and style. We take pride in delivering exceptional products that meet your expectations"</p>
                </div>
    ...
    <div class="nn" style="margin-top:100px;">
        <table class="content-table" style="border-collapse: collapse; text-align:center;">
            <thead>
            <tr style="background-color:rgb(27, 26, 26);text-align:center;">
                <th style="padding: 20px 160px;"> Client ID </th>
                <th style="padding: 20px 160px;"> Client Name </th>
                <th style="padding: 20px 160px;"> Email </th>
                <th style="padding: 20px 160px;"> Review </th>
            </tr>
            </thead>
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($rows = mysqli_fetch_assoc($result)) {
                        echo '<tr style="border-bottom: none; background-color:rgba(255, 255, 255, 0);">
                                <td style="background-color:rgba(255, 255, 255, 0);">' . $rows["CReviewID"] . '</td>
                                <td style="background-color:rgba(255, 255, 255, 0);">' . $rows["CReviewName"] . '</td>
                                <td style="background-color:rgba(255, 255, 255, 0);">' . $rows["CReviewEmail"] . '</td>
                                <td style="background-color:rgba(255, 255, 255, 0);">' . $rows["CReviewDesc"] . '</td>
