...
<body>
    ...
    <div class="flex-details">
        ...
        <div class="chairman-details">
            ...
            <h1>Welcome, Business Development Manager !</h1>

            <p>We are excited to welcome you to our platform! As a valued Business Development Manager,
                 you now have access to a comprehensive set of tools and resources to help you drive business growth, 
                 identify new opportunities, collaborate with your team, and track key performance metrics to enhance operational success and expansion.</p>
    ...
    <div class="roles-response-slideshow">
        ...
        <div class="left-side">
            ...
            <ul class="roles-list">
                ...
                <li>Strategically overseeing business operations and ensuring the successful implementation of long-term growth and market expansion plans.</li>
                <li>Leading key business development meetings and supporting high-level decision-making processes.</li>
                <li>Managing business activities, ensuring compliance with regulations, and addressing risks related to market opportunities and partnerships.</li>
                <li>Collaborating closely with senior leadership to define business development goals and ensure alignment with overall company objectives.</li>
                <li>Representing the company in external partnerships, industry events, and business growth initiatives.</li>
        ...
        <div class="slideshow-container">
            ...
            <div class="slideshow">
                ...
                <img src="../Chairman Home/04.png" class="slide">
    ...
    <div class="tools">
        ...
        <div class="image-container">
            ...
            <div class="text-overlay">Sales Report</div>
            <p class="p-overlay">A document that provides detailed information about a company's sales performance over a specific period.</p>
            <a class="btn-overlay" href="../Reports/Sales Report/pdf.php" target="_blank">Create Sales Report</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay-worker">Sales</div>
            <p class="p-overlay-refer">Refer to the activities involved in selling products or services to customers in exchange for money or other compensation.</p>
            <a class="btn-overlay-add" style="top: 70%;" href="../Business Manager Functions/Sales/sales.php" >Manage Sales</a>
        </div>
