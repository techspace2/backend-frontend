...
if(isset($_POST['order_btn'])){
   ...
   $cart_query = mysqli_query($conn, "SELECT * FROM `cart` WHERE login_id='$id'");
   $price_total = 0;
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `order`(name, number, email, method, flat, street, city, state, country, pin_code, total_products, total_price ,login_id) VALUES('$name','$number','$email','$method','$flat','$street','$city','$state','$country','$pin_code','$total_product','$price_total','$id')") or die('query failed');
   ...
   if($cart_query && $detail_query){
      ...
      <div class='message-container'>
         ...
         <div class='customer-details'>
            ...
            <a href='../Client/Orders UI/page 1.php' class='btn'>continue shopping</a>
         </div>
      </div>
      ";
   }
...
<div class="nav-btns">
    ...
    <a class="profile-btn" href="javascript:history.back()">Back</a>
