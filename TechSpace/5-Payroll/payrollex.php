...
<head>
    ...
    <link rel="stylesheet" href="payrollex.css">
...
<body>
    ...
    <div class="flex-details">
        ...
        <img src="payroll ex.png" alt="">


        <div class="chairman-details">

            <h1>Welcome, Payroll Executive !</h1>

            <p>We’re excited to have you on board! As an important Payroll Executive, you now have access to a full range of payroll management 
                tools and resources. These will assist you in efficiently handling payroll tasks, working closely with your team, and ensuring 
                accurate and timely compensation, all contributing to the smooth operation and satisfaction of our workforce.
            </p>
    ...
    <div class="roles-response-slideshow">
        ...
        <div class="left-side">
            ...
            <ul class="roles-list">
                ...
                <li>Overseeing payroll strategy and ensuring accurate, timely processing of employee compensation.</li>
                <li>Leading payroll-related meetings and decision-making processes.</li>
                <li>Ensuring compliance with payroll regulations, tax laws, and internal policies.</li>
                <li>Aligning payroll objectives with overall company priorities.</li>
                <li>Managing employee compensation inquiries, benefits administration, and payroll-related partnerships.</li>
                <li>Providing guidance and support to HR and executive teams to enhance payroll operations.</li>
                <li>Offering expertise to leadership on payroll processes and compliance issues.</li>
    ...
    <div class="tools">
        ...
        <div class="image-container">
            ...
            <div class="text-overlay">Salary</div>
            <p class="p-overlay">A fixed, regular payment made by an employer to an employee for their work, typically expressed as an annual amount,</p>
            <a class="btn-overlay" href="../Payroll Functions/Cal Salary/CalSalary.php">Calculate Salary</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay-budget">Pay Slips</div>
            <p class="p-overlay">  A document issued by an employer to an employee that outlines the details of their salary.</p>
            <a class="btn-overlay-setbud" style="top: 70%;" href="../Payroll Functions/Payslip/payslip.php">Generate Pay Slips</a>
        </div>

        
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="task-overlay">Payroll Records</div>
            <p class="p-overlay"> Documents that track and store information related to employee compensation .</p>
            <a class="btn-overlay-rev" style="top: 70%;" href="../Payroll Functions/Payroll Record/payrollrecord.php">Manage Payroll Records</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay-profit">Overtime Payments</div>
            <p class="p-overlay">The additional compensation an employee receives for working beyond their regular, contracted hours.</p>
            <a class="btn-overlay" href="../Payroll Functions/OT/ot.php">Calculate OT Payments</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="feedback-overlay">Payments</div>
            <p class="p-overlay"> Transfer of money or its equivalent from one party to another in exchange for goods
                or services</p>
            <a class="btn-overlay-client" href="">Handle Payments</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="feedback-overlay-report">Taxes</div>
            <p class="p-overlay">Mandatory financial charges or levies imposed by a government on  businesses.</p>
            <a class="btn-overlay-addrep" href="../Payroll Functions/Tax/tax.php">Include Taxes to Payroll</a>
        </div>

        
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="trans-overlay">Special Benefits</div>
            <p class="p-overlay">Additional compensation or perks provided by an employer to employees, beyond regular wages or salary.</p>
            <a class="btn-overlay-client" href="../Payroll Functions/Special Benefit/benefit.php">Add Special Benefits to <br> Payroll</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="trans-overlay">Advance Payments</div>
            <p class="p-overlay"> Funds paid by a buyer or client to a seller or service provider before the goods or services are delivered or completed.</p>
            <a class="btn-overlay-client" href="../Payroll Functions/Advance Payment/advancepay.php">Manage Advance Payments</a>
        </div>
