...
?>
    ...
    <div class="search-bar">
       ...
       <a href="../../shopping cart/cart.php" class="cart"><img src="cart.png" alt=""><span><?php echo $row_count; ?></span> </a>
    ...
    <div class="slideshow-container">
        ...
        <div class="slideshow-content">
            <label for="" class="shop-btn">Best Seller</label>
        </div>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE type='Best Seller'");
    ...
    <div class="down" style="margin-left: 0px; padding:130px; width:100%;">
        ...
        <div class="ppp" style="margin-left:40px;">
           ...
           <form method="post" id="form2">
            ...
            <div class="newsletter">
                ...
                <input type="email" id="txtnews" name="txtnews" placeholder="Enter your email address" style="background-color: white;">
                <div style="font-size:24px; margin-top:20px;" class="error"></div>
                </div>
