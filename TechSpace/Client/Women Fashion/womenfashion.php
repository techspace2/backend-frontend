...
<head>
    ...
    <link rel="stylesheet" href="womenfashion.css">
...
?>
    ...
    <div class="slideshow-container">
        ...
        <div class="slideshow-content">
            <label for="" class="shop-btn">Women Fashion</label>
        </div>
   ...
   <div class="box-container">
      ...
      $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE type='Females Fashion'");
    ...
    <div class="down" style="margin-left: 0px; padding:130px; width:100%;">
        ...
        <div class="ppp">
            ...
            <?php 
              if ($deleted=== true) {
                     echo '<div style="color: green; font-weight: bold;">Email registered .</div>';
              } 
             ?>
             </div>
