...
<body>
    ...
    <div class="flex-details">
        ...
        <div class="chairman-details">
            ...
            <h1>Welcome, HR/Compliance Manager !</h1>

            <p>We are thrilled to welcome you to our platform! As a valued HR and Compliance Manager, 
                you now have access to a complete set of tools and resources to help you effectively 
                manage human resources, ensure regulatory compliance, collaborate with your team, and 
                monitor key performance metrics to support organizational growth and success.
            </p>
    ...
    <div class="roles-response-slideshow">
        ...
        <div class="left-side">
            ...
            <ul class="roles-list">
                ...
                <li>Providing strategic oversight of the organization’s HR plans and ensuring the successful implementation of long-term talent and workforce development initiatives.</li>
                <li>Leading key HR meetings and supporting high-level decision-making processes.</li>
                <li>Managing employee relations, ensuring regulatory compliance, and addressing workforce risk management.</li>
                <li>Collaborating closely with senior leadership to define HR goals and align with the company’s overall priorities.</li>
                <li>Representing the organization in external partnerships, industry events, and talent acquisition activities.</li>
    ...
    <div class="tools">
        ...
        <div class="image-container">
            ...
            <div class="text-overlay">Worker Details</div>
            <p class="p-overlay">Refer to the personal, professional, and employment-related information about an employee or worker.</p>
            <a class="btn-overlay" href="../HR functions/Worker/worker.php">Mange Worker </a>
        </div>
        
        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="task-overlay">Worker Training Schedules</div>
            <p class="p-overlay">Refer to planned timetables for training programs designed to enhance the skills and knowledge of employees.</p>
            <a class="btn-overlay" href="../HR functions/Worker Training Schedule/trainschedule.php">Add Worker Training <br>Schedules</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="task-overlay" style="left: 20%;">Latest News/Updates</div>
            <p class="p-overlay">Section is designed to keep visitors informed about recent announcements, events and improvements</p>
            <a class="btn-overlay" href="../HR functions/News Updates/newsupdate.php">Add Recent News</a>
        </div>
