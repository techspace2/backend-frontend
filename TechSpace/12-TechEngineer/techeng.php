...
<head>
    ...
    <link rel="stylesheet" href="techeng.css">
...
<body>
    ...
    <div class="flex-details">
        ...
        <div class="chairman-details">
            ...
            <h1>Welcome, Technical Engineer !</h1>

            <p>We are excited to welcome you to our platform! As a valued Technical Engineer, you now have access
                 to a complete set of tools and resources to help you optimize technical operations, troubleshoot 
                 and resolve challenges, collaborate with your team, and track key performance metrics to drive efficiency and innovation.</p>
    ...
    <div class="roles-response-slideshow">
        ...
        <div class="left-side">
            ...
            <ul class="roles-list">
                ...
                <li>Overseeing technical operations strategically and ensuring the effective implementation of long-term technology development and innovation plans.</li>
                <li>Leading critical technical meetings and assisting in high-level decision-making processes.</li>
                <li>Managing technical activities, ensuring adherence to industry standards, and addressing risks related to systems, projects, and technology.</li>
                <li>Collaborating closely with senior leadership to establish technical goals and align them with the company’s broader objectives.</li>
                <li>Representing the company in external partnerships, technical conferences, and technology advancement initiatives.</li>
    ...
    <div class="tools">
        ...
        <div class="image-container">
            ...
            <div class="text-overlay" style="left: 18%">Machine Conditions</div>
            <p class="p-overlay">The equipment is brand new, unused, and in pristine condition. It has never been operated or subjected to wear and tear.</p>
            <a class="btn-overlay" href="../Technical manager function/Machine Condition'/machinecondition.php">Add Equipment Condition</a>
        </div>

        <div class="image-container">
            <img src="../1-Chairman/tool1.png">
            <div class="text-overlay-worker" style="left: 27%;">Technical Report</div>
            <p class="p-overlay">A detailed document that presents information on a specific technical topic, project, or study.</p>
            <a class="btn-overlay-update" href="../Reports/Technical report/pdf.php" target="_blank">Create Technical Report</a>
        </div>
